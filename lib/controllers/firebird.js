...
var debug =     require('debug')('firebird');
...
Firebird.prototype.fbCreateConnection = function(fn) {
  var _this = this;
  ...
  fb.attach({
    ...
    if (!err) {
      ...
      debug('Firebird.prototype.fbCreateConnection'.magenta, 'host:',     _this.get('fb_host'));
      debug('Firebird.prototype.fbCreateConnection'.magenta, 'database:', _this.get('fb_database'));
      debug('Firebird.prototype.fbCreateConnection'.magenta, 'user:',     _this.get('fb_user'));
      debug('Firebird.prototype.fbCreateConnection'.magenta, 'password:', _this.get('fb_password'));
      debug('Firebird.prototype.fbCreateConnection'.magenta, err);
      fn(err);
    }
...
Firebird.prototype.getFields = function(fields) {
  var tmp = {};
  var types = this.getFieldTypes() || [];

  _.each(fields, function(field) {
    if ((field.alias != null) && (field.type != null) && (types[field.type] != null)) {
      var caption = field.alias.toLowerCase();
      tmp[caption] = field;
