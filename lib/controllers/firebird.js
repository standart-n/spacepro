...
Firebird.prototype.fbTransactionStart = function(fn) {
  var connect,
    _this = this;
  ...
  if (!this.get('fb_global')) {
    if (this.get('fb_connection')) {
      ...
      // connect.transaction(fb.ISOLATION_READ_UNCOMMITTED, function(err, tr) {
        if (tr != null) {
