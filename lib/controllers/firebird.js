...
exports = module.exports = Backbone.Model.extend({
  ...
  fbConnectionOpen: function(fn) {
    ...
    if (!this.get('fb_global')) {
      if (!this.get('fb_error')) {
        if (this.get('fb_connection') == null) {
  ...
  fbConnectionReconnect: function(fn) {
  ...
  fbIsConnectionClose: function() {
    if (!this.get('fb_global')) {
      return this.get('fb_connection') ? false : true;
    } else {
      return global.fb_connection != null ? false : true;
    }
  },
  ...
  fbCheckError: function(err, fn) {
    ...
    if (err != null) {
      ...
      this.fbConnectionReconnect(function() {
        fn(err);
      })
      return true;
    } else {
