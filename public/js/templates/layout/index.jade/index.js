...
buf.push(attrs({ terse: true, 'href':("#dddd"), 'data-toggle':("tab"), 'data-toggle-tab':("tooltip"), 'title':("" + (parentDict.sid) + "") }, {"href":true,"data-toggle":true,"data-toggle-tab":true,"title":true}));
buf.push('> <i');
