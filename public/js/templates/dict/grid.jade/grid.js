...
buf.push(attrs({ 'href':("#dddd"), 'data-target-tab':("" + (parentDict.sid) + ""), 'data-toggle':("tab"), 'data-toggle-tab':("tooltip"), 'title':("" + (parentDict.sid) + "") }, {"href":true,"data-target-tab":true,"data-toggle":true,"data-toggle-tab":true,"title":true}));
buf.push('> <i');
...
{
buf.push('<li><a');
buf.push(attrs({ 'href':("#" + (child.sid) + ""), 'data-target-tab':("" + (child.sid) + ""), 'data-toggle':("tab"), 'data-toggle-tab':("tooltip"), 'title':("" + (child.sid) + "") }, {"href":true,"data-target-tab":true,"data-toggle":true,"data-toggle-tab":true,"title":true}));
buf.push('> <i');
